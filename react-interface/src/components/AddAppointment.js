...
const AddAppointment = ({ onSendAppointment, lastId }) => {
    ...
    function formDataPublish() {
        ...
        onSendAppointment(appointmentInfo); // send the information to the parent component i.e. App
        setFormData(clearData); // clear the form
        setToggleForm(!toggleForm); // untoggle the form
    }
